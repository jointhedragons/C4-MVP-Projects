...
//                 <img
//                     onClick={() => setShowMenu(!showMenu)} // Toggle menu state
...
//                 <div
//                     ref={menuRef}
//                     className={`${showMenu ? 'fixed w-full h-screen translate-x-0' : 'fixed w-full h-screen -translate-x-full'} md:hidden right-0 top-0 z-20 overflow-hidden bg-white transition-transform duration-300 ease-in-out menu-content`}
//                 >
//                     <div className='flex items-center justify-between px-5 py-4 border-b border-gray-200'>
//                         <img className='w-22 h-auto' src={assets.logo} alt='' />
//                         <img
...
//                             <p className='px-4 py-2 rounded-lg inline-block hover:bg-gray-100 transition-colors'>HOME</p>
//                         </NavLink>
//                         <NavLink onClick={() => setShowMenu(false)} to='/tripplanner' className={({ isActive }) => isActive ? 'text-amber-500' : ''}>
//                             <p className='px-4 py-2 rounded-lg inline-block hover:bg-gray-100 transition-colors'>Trip Planner</p>
//                         </NavLink>
//                         <NavLink onClick={() => setShowMenu(false)} to='/trips' className={({ isActive }) => isActive ? 'text-amber-500' : ''}>
//                             <p className='px-4 py-2 rounded-lg inline-block hover:bg-gray-100 transition-colors'>Trips</p>
//                         </NavLink>
//                         <NavLink onClick={() => setShowMenu(false)} to='/blogs' className={({ isActive }) => isActive ? 'text-amber-500' : ''}>
//                             <p className='px-4 py-2 rounded-lg inline-block hover:bg-gray-100 transition-colors'>Blogs</p>
//                         </NavLink>
//                         {token ? (
//                             <div className='flex items-center gap-2 cursor-pointer group relative w-full px-5'>
...
//                                         <p onClick={() => { setToken(false); setShowMenu(false); }} className='hover:text-amber-500 cursor-pointer transition-colors'>Logout</p>
//                                     </div>
//                                 </div>
//                             </div>
//                         ) : (
...
//                                 className='bg-amber-500 text-white px-6 py-2 rounded-full font-medium hover:bg-amber-600 transition-colors w-full text-center'
//                             >
//                                 Sign In
//                             </button>
//                         )}
...
//                         <div className='absolute top-12 right-0 pt-2 text-base font-medium text-gray-600 z-20 hidden group-hover:block'>
//                             <div className='min-w-[180px] bg-white rounded-lg shadow-lg flex flex-col gap-2 p-4 border border-gray-100'>
//                                 <p onClick={() => setToken(false)} className='hover:text-amber-500 cursor-pointer transition-colors'>Logout</p>
//                             </div>
//                         </div>
//                     </div>
//                 ) : (
